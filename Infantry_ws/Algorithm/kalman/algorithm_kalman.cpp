...
{
  mat_init(&F->xhat, 2, 1, (float *)I->xhat_data.data);
  mat_init(&F->xhatminus, 2, 1, (float *)I->xhatminus_data.data);
  mat_init(&F->z, 2, 1, (float *)I->z_data.data);
  mat_init(&F->A, 2, 2, (float *)I->A_data.data);
  mat_init(&F->H, 2, 2, (float *)I->H_data.data);
  mat_init(&F->Q, 2, 2, (float *)I->Q_data.data);
  mat_init(&F->R, 2, 2, (float *)I->R_data.data);
  mat_init(&F->P, 2, 2, (float *)I->P_data.data);
  mat_init(&F->Pminus, 2, 2, (float *)I->Pminus_data.data);
  mat_init(&F->K, 2, 2, (float *)I->K_data.data);
  mat_init(&F->AT, 2, 2, (float *)I->AT_data.data);
  mat_trans(&F->A, &F->AT);
  mat_init(&F->HT, 2, 2, (float *)I->HT_data.data);
  mat_trans(&F->H, &F->HT);
...
void kalman_filter_init(kalman_filter_t *F, kalman_filter_init_t_matrix *I)
{
  mat_init(&F->xhat, 2, 1, (float *)I->xhat_data.data);
  mat_init(&F->xhatminus, 2, 1, (float *)I->xhatminus_data.data);
  mat_init(&F->z, 2, 1, (float *)I->z_data.data);
