...
{
    float q0q0 = mahony_filter->q0 * mahony_filter->q0;
...
{
    mahony_filter->roll = -asinf(mahony_filter->rMat[2][0]); 
    mahony_filter->pitch = atan2f(mahony_filter->rMat[2][1], mahony_filter->rMat[2][2]) ;
