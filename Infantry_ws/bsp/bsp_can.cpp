...
at::RM_Motor RMl3508(2,at::RM_Motors::M3508);
at::RM_Motor RMr3508(3,at::RM_Motors::M3508);
    ...
    if(hfdcan->Instance == FDCAN1)
    {
      ...
      HAL_FDCAN_GetRxMessage(hfdcan, FDCAN_RX_FIFO0, &RxHeader3, g_Can3RxData);
			switch(RxHeader3.Identifier){
				case 202 : RMl3508.read(g_Can3RxData,stamp_ms); break;//zuo
				case 203 : RMr3508.read(g_Can3RxData,stamp_ms); break;
			}
		}
  }
}
