...
void VMC_Class::vmc_calc(float pitch, float pitch_Gyro, float dt, float Joint_motor_front_vel, float Joint_motor_rear_vel){
	...
	point.d_phi0 = jacobi.j12 * Joint_motor_front_vel + jacobi.j22 * Joint_motor_rear_vel; //(point.phi0 - point.last_phi0)/dt;
	...
	point.d_L0 = jacobi.j11 * Joint_motor_front_vel + jacobi.j21 * Joint_motor_rear_vel; //(point.L0 - point.last_L0)/dt;
